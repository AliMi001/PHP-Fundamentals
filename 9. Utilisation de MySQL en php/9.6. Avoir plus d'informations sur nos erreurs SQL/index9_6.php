<?php
    ...
    $requete = $bdd->query("INSERT INTO users(prenom, nom, serie_preferee) VALUES('Mark', 'Zuckergerg')") 
                    or die(print_r($bdd->errorInfo())); // on utilise ici die() pour capturer l'erreur
